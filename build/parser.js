...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c304 = function(expression) {
          return expression;
        },
      peg$c305 = function(type, specifiers, id, value) {
          var v = {
      ...
      peg$c306 = function(type, storage, id) {
          return {
      ...
      peg$c310 = function(argument, operator) {
            return {
      ...
      peg$c324 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c325 = "*",
      ...
      peg$c371 = function(left, operator, right) {
            return {
              type:     "AssignmentExpression",
              operator: operator,
              left:     left,
      ...
      peg$c395 = function(head, tail) { return buildList(head, tail, 1); },
      peg$c396 = function(declarations) {
            return {
      ...
      peg$c398 = function(head, tail, init) {
            return {
      ...
      peg$c401 = function(expression) { return expression; },
      peg$c402 = function() { return { type: "EmptyStatement", start: location().start.offset, end: location().end.offset }; },
      ...
      peg$c404 = function(test, consequent, alternate) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c405 = function(test, consequent) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c406 = function(start_version, end_version) {
          return {
      ...
      peg$c438 = function(fnname, args, returns) {
            return {
              type: "FunctionDeclaration",
              name: fnname.name,
              params: fnname.params,
      ...
      peg$c439 = function(fnname, args, body) {
            return {
      ...
      peg$c441 = function(returnParams) {
      ...
      peg$c445 = function(alias, modifier) {
            if (alias.length > 0) {
      ...
      peg$c446 = function(type, isindexed, isconstant, storage, id) {
          return {
      ...
      peg$c448 = function(id, head, tail) {
          return {
      ...
      peg$c456 = function(id, params, returns, body) {
          return {
      ...
      peg$c457 = "let",
      peg$c458 = peg$literalExpectation("let", false),
      peg$c459 = ":=",
      peg$c460 = peg$literalExpectation(":=", false),
      peg$c461 = function(names, expression) {
          if (expression != null) {
      ...
      peg$c462 = function(names, expression) {
          return {
      ...
      peg$c467 = function(init, test, update, body) {
          return {
            type: "AssemblyFor",
            init: init,
            test: test,
  ...
  function peg$parseStorageSlotSpecifier() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;
  ...
  function peg$parseStateVariableSpecifiers() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        ...
        s1 = peg$parse__();
        if (s1 !== peg$FAILED) {
          s2 = peg$parseStorageSlotSpecifier();
          if (s2 !== peg$FAILED) {
            s3 = peg$parse__();
            if (s3 !== peg$FAILED) {
              peg$savedPos = s0;
  ...
  function peg$parseStateVariableDeclaration() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = [];
        s4 = peg$parseStateVariableSpecifiers();
        while (s4 !== peg$FAILED) {
          s3.push(s4);
          s4 = peg$parseStateVariableSpecifiers();
        }
